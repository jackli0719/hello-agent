...
interface LoginFormProps {
  /** RSC 阶段已通过 ensureCsrfCookie() 写入 cookie 的 token */
  csrfToken: string;
}

/**
 * 登录表单（client component）。
 * csrfToken 由 server component 传过来，**不再**在 useEffect 里读 cookie（避免 cookie 不存在时报错）。
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* [v0.6.0] CSRF token — RSC 阶段写入 cookie o2o_csrf + 传 prop */}
        <input
